...
object RunSessionPowerEstimate {
    /** Matches [com.pixson.apbfit.service.AccountRunContext] stop-poll chunk size. */
    const val STOP_POLL_INTERVAL_MS = 500L

    /** Matches three [com.pixson.apbfit.domain.fit.GoogleFitWriter.writeSegments] calls per batch. */
