...
class RunForegroundService : LifecycleService() {
    ...
    private suspend fun buildAccountsByRunId(
        runs: List<com.pixsonlin.apbfit.data.db.entity.RunEntity>,
    ...
    companion object {
        ...
        const val ACTION_START_SESSION = "com.pixsonlin.apbfit.action.START_SESSION"
        const val ACTION_FINALIZE_ORPHAN = "com.pixsonlin.apbfit.action.FINALIZE_ORPHAN"
        const val ACTION_SCHEDULE_TICK = "com.pixsonlin.apbfit.action.SCHEDULE_TICK"
        const val ACTION_STOP_SESSION = "com.pixsonlin.apbfit.action.STOP_SESSION"
