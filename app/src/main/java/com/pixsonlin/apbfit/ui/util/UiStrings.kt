...
class UiStrings @Inject constructor(
    ...
    val healthConnectPermissionsUpdated: String get() = get(R.string.msg_health_connect_permissions_updated)
    val healthConnectPermissionsIncomplete: String get() = get(R.string.error_health_connect_permissions_incomplete)
    val healthConnectUnavailable: String get() = get(R.string.error_health_connect_unavailable)
    val healthConnectPermissionsPrompt: String get() = get(R.string.msg_health_connect_permissions_prompt)
    ...
    val debugHcRunStarted: String get() = get(R.string.msg_debug_hc_run_started)
